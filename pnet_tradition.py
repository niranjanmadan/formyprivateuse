	...
	def __init__(self, scope_name):
		...
		with tf.variable_scope(self.scope):
			with tf.variable_scope('p_fuse'):
				self.weight_vars.append(self._create_variables(5, 16, 3, scope = 'conv1'))
				...
				self.weight_vars.append(self._create_variables(64, 128, 3, scope = 'conv4'))
				...
				self.weight_vars.append(self._create_variables(256, 128, 3, scope = 'conv6'))
